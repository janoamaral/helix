...
Public Class SQLEngineDB
    ...
    '        ' Get list of user tables
    '        ' Para saber mas del uso de restricciones: http://msdn.microsoft.com/es-es/library/cc716722.aspx
    '        _userTables = connection.GetSchema("Tables", New String() {Nothing, Nothing, Nothing, "TABLE"})
    '        connection.Close()
    '    Catch ex As Exception
    '        Return False
    '    End Try
    ...
    'Public Function GetTableName(ByVal index As Integer) As String
    '    If index >= 0 Then
    '        Return _userTables.Rows(index)(2).ToString
    '    Else
    '        Return ""
    '    End If
    'End Function
    ...
    ' ''' <summary>
    ' ''' Indica la cantidad de columnas de una tabla especifica
    ' ''' </summary>
    ' ''' <param name="table">El indice correspondiente a la tabla</param>
    ' ''' <returns>La cantidad de columnas que posee</returns>
    'Public Function GetTableColumnsCount(ByVal table As Integer) As Integer
    '    GetTableInfo(table)
    '    Return _TableInfo.ColumnsCount
    'End Function

    ' ''' <summary>
    ' ''' Indica la cantidad de filas de una tabla especifica
    ' ''' </summary>
    ' ''' <param name="table">El indice correspondiente a la tabla</param>
    ' ''' <returns>La cantidad de filas que posee</returns>
    'Public Function GetTableRowsCount(ByVal table As Integer) As Integer
    '    GetTableInfo(table)
    '    Return _TableInfo.RowCount
    'End Function

    ' ''' <summary>
    ' ''' Lee el nombre de la columna de una tabla especifica
    ' ''' </summary>
    ' ''' <param name="table">Indice de la tabla que contiene la columna</param>
    ' ''' <param name="column">Indice de la columna</param>
    ' ''' <returns>El nombre de la columna</returns>
    'Public Function GetTableColumnName(ByVal table As Integer, ByVal column As Integer) As String
    '    GetTableInfo(table)
    '    Return _TableInfo.GetColumnName(column)
    'End Function

    ' ''' <summary>
    ' ''' Lee el nombre de un campo de una tabla especifica
    ' ''' </summary>
    ' ''' <param name="table">Indice de la tabla que contiene el campo</param>
    ' ''' <param name="row">Indice de la campo</param>
    ' ''' <returns>El nombre del campo</returns>
    'Public Function GetTableRowName(ByVal table As Integer, ByVal row As Integer) As String
    '    GetTableInfo(table)
    '    Return _TableInfo.GetRowName(row)
    'End Function

    ' ''' <summary>
    ' ''' Lee la propiedad de un campo en una tabla especifica
    ' ''' </summary>
    ' ''' <param name="table">Indice de la tabla que contiene el campo</param>
    ' ''' <param name="row">Indice del campo</param>
    ' ''' <param name="column">Indice de la columna</param>
    ' ''' <returns>La propiedad del campo </returns>
    'Public Function GetTableFieldInfo(ByVal table As Integer, ByVal row As Integer, ByVal column As Integer) As String
    '    GetTableInfo(table)
    '    Return _TableInfo.GetCellInfo(column, row)
    'End Function



    ' ''' <summary>
    ' ''' Busca la informacion de la tabla para poder ser procesada
    ' ''' </summary>
    ' ''' <param name="table">Indice de la tabla a buscar</param>
    'Private Sub GetTableInfo(ByVal table As Integer)
    '    _TableInfo.TableName = Me.GetTableName(table)
    '    _TableInfo.GetTableInfo()
    'End Sub
